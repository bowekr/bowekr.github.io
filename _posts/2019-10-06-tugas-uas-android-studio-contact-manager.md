...
### Component Program
- 4 Activity (LoginActivity, MainActivity, AddActivity, EditActivity)
- Toast
- ListView
...
![Halaman Login / Login Activity](https://www.dropbox.com/s/a5yw2p5ij4gac9q/Login%20Activity.jpeg?raw=1)
...
idx.constraintlayout.widget.ConstraintLayout xmlns:android="http://schemas.android.com/apk/res/android"
...
public class LoginActivity extends AppCompatActivity {
    ...
    public void login(View view) {
        ...
        if (textUsername != getString(R.string.username) && textPassword != getString(R.string.password)) {
            Toast.makeText(getBaseContext(), "Username dan password salah!", Toast.LENGTH_LONG).show();
            return;
        }

        Toast.makeText(getBaseContext(), "Selamat Datang " + textUsername, Toast.LENGTH_LONG).show();
